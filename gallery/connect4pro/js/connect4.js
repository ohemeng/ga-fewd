...
// function passToBlue(blueLeftPos){
//  	// $(document).mousemove(function(event){
...
function canBluePlay(){
	if(goForward === "yes"){;
		...
		} else if(randNum === 2 && arrayB.length != 0){
			bPosition = arrayB[0];
			nextPosition = bPosition;
			blueLeftPos = ".b";
			if (arrayB.length >=1){
		...
		} else if(randNum === 3 && arrayC.length != 0){
			cPosition = arrayC[0];
			nextPosition = cPosition;
			blueLeftPos = ".c";
			if (arrayC.length >=1){
		...
		} else if(randNum === 4 && arrayD.length != 0){
			dPosition = arrayD[0];
			nextPosition = dPosition;
			blueLeftPos = ".d";
			if (arrayD.length >=1){
		...
		} else if (randNum === 5 && arrayE.length != 0){
			ePosition = arrayE[0];
			nextPosition = ePosition;
			blueLeftPos = ".e";
			if (arrayE.length >=1){
		...
		} else if (randNum === 6 && arrayF.length != 0){
			fPosition = arrayF[0];
			nextPosition = fPosition;
			blueLeftPos = ".f";
			if (arrayF.length >=1){
		...
		} else if (randNum === 7 && arrayG.length != 0){
			gPosition = arrayG[0];
			nextPosition = gPosition;
			blueLeftPos = ".g";
			if (arrayG.length >=1){
